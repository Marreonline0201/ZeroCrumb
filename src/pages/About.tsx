    ...
    <div className="max-w-md mx-auto py-8 px-4">
      <div className="space-y-6">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-zinc-100 mb-2">ZeroCrumbs</h1>
        ...
        <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6">
          ...
          <p className="text-zinc-300 text-sm leading-relaxed">
            ZeroCrumbs makes it simple to track your meals and understand your nutrition. Just snap a photo, and our AI analyzes your food to give you instant insights on calories, macros, and nutritional value.
          </p>
        </div>
        ...
        <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6">
          ...
          <p className="text-zinc-300 text-sm">
            Have questions or feedback? We'd love to hear from you! Join our community and help us make ZeroCrumbs even better.
          </p>
        </div>
